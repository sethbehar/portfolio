    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col'>
                <span>1. Cold plunging daily <span className='text-sm'>(75+ day streak)</span></span><br/>
                <span>2. Chess <span className='text-sm'>(sethbehar on chess.com)</span></span><br/>
                <span>3. Long distance runs <span className='text-sm'>(training for 50k)</span></span><br/>
                ...
                <span>8. Calisthenics <span className='text-sm'>(training for handstand pushup)</span></span><br/>
